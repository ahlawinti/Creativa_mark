            ...
            <div id="content" >
                 <div class="row filter-box">
                     <div class="col-md-10 col-md-offset-1 row">
                        ...
                        <div class="col-xs-12 col-lg-3"><a href="creativainterns.php"><button class="filter-button"  id="filter-active" >Creativa Interns</button></a></div>
                 ...
                 <div class="row">
                     <?php 
                       $pdo = Database::connect();
                                             $sql = "SELECT * FROM people WHERE title='interns'  ORDER BY name ASC ";
