            ...
            <div id="content" >
                 <div class="row filter-box">
                     <div class="col-md-10 col-md-offset-1 row">
                        ...
                        <div class="col-xs-12 col-lg-3"><a href="creativastartups.php"><button class="filter-button"  id="filter-active" >Creativa Startups</button></a></div>
                 ...
                 <div class="row">
                     <?php 
                       $pdo = Database::connect();
                                             $sql = "SELECT * FROM people WHERE title='startups'  ORDER BY name ASC ";
                  ...
                  <div class="row">
                     <div class="col-xs-12 col-lg-2 col-lg-offset-5">
                        <button  style="width:100%;" type="button" class="btn btn-success" onclick="window.open('service.php?service=Coworking')">Join us</button>
                     </div>
                 </div>
            </div>
        </div>
